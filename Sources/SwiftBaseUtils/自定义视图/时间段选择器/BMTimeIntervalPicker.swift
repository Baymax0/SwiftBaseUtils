...
class BMTimeIntervalPicker: UIView {
    ...
    static func share() -> BMTimeIntervalPicker{
...
//        var temp3 =
    ...
    func setCallBack(_ callBack:@escaping (BMTimeIntervalPicker)->(Bool)){
        self.resultCallBack = callBack
    }

    @objc func chooseDateAction(_ btn:UIButton) {
...
extension BMTimeIntervalPicker{
    ...
    func getArr(_ min:Int, _ max:Int) -> Array<String>{
    ...
    func getDateString(_ date:Date, _ formateStr:String) -> String{
        return date.toString(formateStr)
    }
    
    func getDate(_ string:String, _ formateStr:String) -> Date{
        return string.toDate(formateStr)
    }
    
    func numberOfDays(_ month:Int , _ year:Int) -> Int{
