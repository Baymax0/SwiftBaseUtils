...
class CityDBManager {
    ...
    static let share:CityDBManager = {
    ...
    func getAddressModel(_ provinceId:Int64!,_ cityId:Int64!,_ districtsId:Int64!) -> Array<Address>{
    ...
    func getProvinceList() -> Array<Address> {
    ...
    func getCityList(_ chooseProvinceid:Int64) -> Array<Address> {
    ...
    func getDistrictList(_ chooseCityid:Int64) -> Array<Address> {
