...
class QRCodeManager: NSObject {
    ...
    class func createQRCode(_ qrCode:String!, _ size :CGFloat, handle:@escaping (UIImage)->()){
    ...
    /// 将二维码画到台卡上
    class func createQRCodeWithBGImage(bgImg:String, loc:CGRect, _ qrCode:String!, handle:@escaping (UIImage)->()){
        if qrCode == nil{
            return
        }
